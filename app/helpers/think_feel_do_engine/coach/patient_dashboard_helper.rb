  ...
  module Coach
    ...
    module PatientDashboardHelper
      ...
      def activities_planned_today(participant)
        participant.activities.planned.updated_for_day(Date.today).count +
          participant.activities.reviewed_and_complete.updated_for_day(Date.today).count +
          participant.activities.reviewed_and_incomplete.updated_for_day(Date.today).count
      end
